<div> {{-- Div-padre --}}
    ...
    <x-jet-dialog-modal wire:model="open">
        ...
        <x-slot name="content">
            ...
            {{-- foto perfil --}}
            <div class=" mb-4 mt-1 flex justify-center px-6 pt-5 pb-6 border-2 border-gray-300 border-dashed rounded-md">
                <div class="space-y-1 text-center">                    
                    <div class="flex text-sm text-gray-600">
                        <label for="file-upload"
                            class="relative cursor-pointer bg-white rounded-md font-medium text-green-600 hover:text-green-500 focus-within:outline-none focus-within:ring-2 focus-within:ring-offset-2 focus-within:ring-green-500">
                            <span>Subir foto de perfil</span>
                            <input id="file-upload" name="file-upload" type="file" class="sr-only"  wire:model="foto_perfil">
                        </label>
                        <p class="pl-1">o arrastre y suelte</p>
                    </div>
                    <p class="text-xs text-gray-500">
                        PNG, JPG, GIF sobre 10MB
                    </p>
                </div>
            </div>
